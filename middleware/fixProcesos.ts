...
const getProcesosfromRadicados =
  radicados.map(
    ( radicado, ) => radicado.procesos
  );

const polishProcesos = getProcesosfromRadicados.forEach(
  ( procesos, index ) => {
...
fs.writeFile( 'data/cleanProcesos.json', JSON.stringify( nonMissingProcesos ) );